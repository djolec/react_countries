...
const BorderButton = ({ border }) => {
    ...
    if(!isLoading) {
        ...
        return (
            <button className="bg-[var(--elem)] 2xl:text-2xl text-[var(--text)] hover:text-[var(--orange)]  mt-[10px] transition-colors ease-in-out duration-150 shadow-[1px_2px_6px_2px_rgba(0,0,0,0.3)]">
